...
def build_analysis(s:MarketSnapshot,generated_at:Optional[int]=None)->Analysis:
    ...
    selected="";exe=[z for z in best if z.grade in (Grade.A_PLUS,Grade.A,Grade.B_PLUS)]
