...
#property description "DEMO/PAPER telemetry bridge with runtime-truth journal versions, fixed preprocessor include contract, current execution tags, V659 zones, and execution ownership."

#define TZ_JOURNAL_BRIDGE_VERSION "1.38"
...
int OnInit()
{
   ...
   Print("AITS DataBridge runtime v",TZ_BRIDGE_VERSION," active: compile-safe journal truth + current execution tags + V659 zones + ownership visualization.");
