...
#property description "DEMO/PAPER bridge with Sequence 3.35 execution-truth overlay, provenance-safe journal recovery, V659 zones, and ownership."

#define TZ_JOURNAL_BRIDGE_VERSION "1.43"
...
#define TZ_BRIDGE_VERSION "1.43"
#define TZ_SEQUENCE_EXPECTED "3.35"
...
int OnInit()
{
   ...
   TZ_SendSnapshotCycle("V143_VERIFY");
   RefreshPlanContext();
   TZ_ReadTwoZoneMap();
   TZR_RefreshAndRender();
   TZ_RenderTwoZoneMap();
   TZ_WriteBridgeState();
   TZ_SendHeartbeatV143();
