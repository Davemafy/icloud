...
#property description "DEMO/PAPER telemetry bridge with visible snapshots, V659 zone shading, and explicit read-only execution ownership."
...
#define TZ_BRIDGE_VERSION "1.36"
#define TZ_SEQUENCE_EXPECTED "3.26"
...
int OnInit()
{
   ...
   TZ_SendSnapshotCycle("V136_VERIFY");
   RefreshPlanContext();
   TZ_ReadTwoZoneMap();
   ...
   Print("AITS DataBridge runtime v",TZ_BRIDGE_VERSION," active: visible snapshots + V659 zones + explicit execution-ownership visualization.");
