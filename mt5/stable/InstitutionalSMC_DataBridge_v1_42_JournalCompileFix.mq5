...
#property description "DEMO/PAPER bridge with provenance-safe journal recovery, compile-safe tester guard, execution-truth overlay, V659 zones, and ownership."

#define TZ_JOURNAL_BRIDGE_VERSION "1.42"
...
int OnInit()
{
   ...
   TZ_SendSnapshotCycle("V142_VERIFY");
   RefreshPlanContext();
   TZ_ReadTwoZoneMap();
   TZR_RefreshAndRender();
   TZ_RenderTwoZoneMap();
   TZ_WriteBridgeState();
   TZ_SendHeartbeatV142();
