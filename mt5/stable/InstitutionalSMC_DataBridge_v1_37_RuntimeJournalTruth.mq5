...
#property description "DEMO/PAPER telemetry bridge with runtime-truth journal versions, current execution tags, V659 zones, and execution ownership."

#define TZ_JOURNAL_BRIDGE_VERSION "1.37"\n#define OnInit TZ_BridgeCore_OnInit
...
#define TZ_BRIDGE_VERSION "1.37"
#define TZ_SEQUENCE_EXPECTED "3.33"
...
void TZ_RenderTwoZoneMap()
{
   ...
   string status="SMC Cloud | MAP "+IntegerToString(g_tzMapCount)+
...
int OnInit()
{
   ...
   TZ_SendSnapshotCycle("V137_VERIFY");
   RefreshPlanContext();
   TZ_ReadTwoZoneMap();
   ...
   Print("AITS DataBridge runtime v",TZ_BRIDGE_VERSION," active: runtime-truth journal versions + current execution tags + V659 zones + ownership visualization.");
