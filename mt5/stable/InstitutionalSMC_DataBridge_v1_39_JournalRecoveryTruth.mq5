...
#property description "DEMO/PAPER telemetry bridge with idempotent journal recovery, runtime-truth versions, compile-safe include contract, V659 zones, and execution ownership."

#define TZ_JOURNAL_BRIDGE_VERSION "1.39"
