...
#property description "DEMO/PAPER bridge with provenance-safe journal recovery, execution-truth overlay, V659 zones, and ownership."

#define TZ_JOURNAL_BRIDGE_VERSION "1.41"
...
int OnInit()
{
   ...
   TZ_SendSnapshotCycle("V141_VERIFY");
   RefreshPlanContext();
   TZ_ReadTwoZoneMap();
   TZR_RefreshAndRender();
   TZ_RenderTwoZoneMap();
   TZ_WriteBridgeState();
   TZ_SendHeartbeatV141();
   Print("AITS DataBridge runtime v",TZ_BRIDGE_VERSION," active: provenance-safe journal recovery + execution-truth overlay + V659 zones + ownership visualization.");
